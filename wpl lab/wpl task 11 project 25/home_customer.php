...
<i class="fas fa-gamepad me-2" style="color: red;"></i> Nintendo Switch
    ...
    <i class="fa-solid fa-user me-2" style="color: blue;"></i><span style="color: blue;"><b><?php echo $user['name'];?></b></span>
   </a>
      <a href="signout.php" target="" class="list-group-item list-group-item-action ps-4">
<i class="fa-solid fa-user-times me-2" style="color: red;"></i><span style="color: red;">Sign Out</span>
   </a>
            </div>
        </div>
      </div>
